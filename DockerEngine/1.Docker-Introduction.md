...
#### vi Dockerfile
	...
	RUN echo "<center> <h1> Hello-World!!! </h1> </center>" > /var/www/html/index.html #In few nginx versions we can find default web file in /usr/share/nginx/html/index.html
	EXPOSE 80
